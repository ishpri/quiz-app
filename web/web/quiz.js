...
let questions = [
  ...
  restart_quiz.onclick = () => {
    ...
    window.location.href = "quiz.html"; //reload the current window
  };
  
  // if quitQuiz button clicked
  quit_quiz.onclick = () => {
    window.location.href = "sign.html"; //reload the current window
  };
